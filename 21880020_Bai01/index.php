    ...
    <div class="row m-2" id="row">
      ...
      <div class="col-8 content" id="right">
        <div class="" id="above">
            ...
            <h2>
              <?php
                print "Bài 01 - Môi trường phát triển<br>Kết quả: hoàn thành";
              ?>
            </h2>
            <div>
              <img src="../images/Bai1_cau1_1.png" alt="">
              <img src="../images/Bai1_cau1_2.png" alt="">
              <img src="../images/Bai1_cau2.png" alt="">
            </div>
        </div>
        <?php 
