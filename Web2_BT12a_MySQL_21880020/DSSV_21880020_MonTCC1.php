      ...
      <div class="col-8 content" id="right">
        <div class="" id="above">
          ...
          <h1 class="text-center">
            Kết quả môn học TCC1
          </h1>         
          <div>
            
                <?php 
                  $db_name="qldangky_21880020";
                  $db_server="localhost";
                  $db_loginname="root";
                  $db_password="";
                  ...
                  $sqldau='SELECT sinhvien.MSSV,sinhvien.TenSV,sinhvien.DTB, dkhoc.Diem FROM dkhoc LEFT JOIN sinhvien on dkhoc.MaSV=sinhvien.MSSV where dkhoc.MaMH="TCC1" AND dkhoc.Diem>=5;';
                  $sqlrot='SELECT sinhvien.MSSV,sinhvien.TenSV,sinhvien.DTB, dkhoc.Diem FROM dkhoc LEFT JOIN sinhvien on dkhoc.MaSV=sinhvien.MSSV where dkhoc.MaMH="TCC1" AND dkhoc.Diem<5;';
