        ...
        <div class="" id="above">
          ...
          <div>
                ...
                <?php 
                  ...
                  $sqldau='SELECT sinhvien.MSSV,sinhvien.TenSV,sinhvien.DTB, dkhoc.Diem FROM dkhoc LEFT JOIN sinhvien on dkhoc.MaSV=sinhvien.MSSV where dkhoc.MaMH="TKPM" AND dkhoc.Diem>=5;';
                  $sqlrot='SELECT sinhvien.MSSV,sinhvien.TenSV,sinhvien.DTB, dkhoc.Diem FROM dkhoc LEFT JOIN sinhvien on dkhoc.MaSV=sinhvien.MSSV where dkhoc.MaMH="TKPM" AND dkhoc.Diem<5;';
